...
public class stationery extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    String[] sex = {"BOOK","PEN","PENCIL"};
    Spinner gender;
    TextView txt1;
    EditText edther;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gender = findViewById(R.id.gender0);
        edther = findViewById(R.id.bc_dob0);
        gender.setOnItemSelectedListener(this);
        ArrayAdapter aa = new ArrayAdapter(this, android.R.layout.simple_spinner_item, sex);
        aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        scanid = findViewById(R.id.button70);
        payamt = findViewById(R.id.button60);
        txt1 = findViewById(R.id.textView110);
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                if (response.equals("Success")) {
                                    Toast.makeText(stationery.this, "Payment Recived", Toast.LENGTH_LONG).show();
                                } else {
                                    Toast.makeText(stationery.this, "Unsuccesfull attempt", Toast.LENGTH_LONG).show();
                                }
...
//Adding the string request to the queue
                RequestQueue requestQueue = Volley.newRequestQueue(stationery.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (result != null) {
            if (result.getContents() == null) {
                ...
                try {
                    Toast.makeText(stationery.this,decrypt(result.getContents(),"mylove"),Toast.LENGTH_LONG).show();
